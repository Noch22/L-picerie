<?php
    ...
    $content = $exposition->post_content;
    endforeach;
?>
...
<div class="rdv">
    ...
    <div class="element <?= $border_class ?> border">
        <div class="type">
    ...
    <script>
            function showcard(eventIndex) {
                ...
                var borderClass = 'border-' + eventIndex;
                var card = document.querySelector('.' + descriptionClass);
                var element = document.querySelector('.' + borderClass);
...
document.addEventListener('mousedown', function(event) {
    ...
    // Vérifier si le clic n'est pas à l'intérieur du sidebar et que le sidebar est actif
